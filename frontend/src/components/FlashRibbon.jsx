...
const FlashRibbon = () => {
  ...
  // Triplicate brands array to guarantee seamless smooth infinite scrolling
  ...
  return (
    <section className="w-full py-6 bg-gradient-to-r from-purple-50/60 via-indigo-50/40 to-purple-50/60 border-y border-purple-100/70 overflow-hidden relative shadow-[inset_0_1px_3px_rgba(157,78,141,0.03)]">
      ...
      <div className="w-full flex whitespace-nowrap animate-marquee hover:[animation-play-state:paused] cursor-pointer">
