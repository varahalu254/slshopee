        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
            ...
            <div className="space-y-12">
              ...
              {/* Minimal Studio Image Card */}
              <div className="relative rounded-[40px] overflow-hidden group h-64 shadow-2xl">
                <img
                ...
                <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center p-8 text-center">
                  <h4 className="text-2xl font-display font-bold text-white mb-4">Visit Our Main Studio</h4>
                  <a
                    href="https://share.google/IgsN3lVSHExKkHJzF"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white text-gray-900 px-6 py-2.5 rounded-xl font-body font-bold text-xs uppercase tracking-widest hover:bg-gray-100 transition-colors shadow-lg"
                  >
                    Get Directions
                  </a>
                </div>
